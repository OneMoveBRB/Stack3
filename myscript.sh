...
source="g++ main.cpp dynamic_stack_funtionality.cpp stack_functionality.cpp stack_protection.cpp utils.cpp -o stack"

flags=" \
-D _STACK_DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat \
